...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">PAGIBIG Contributions List</h3>
        <div class="card-tools">
            <a href="{{ route('pagibig.create') }}" class="btn btn-success btn-sm rounded-pill">
                Add Pagibig Contribution <i class="fas fa-plus-circle"></i>
            </a>
...
<div class="modal fade" id="createAllModal" tabindex="-1" role="dialog" aria-labelledby="createAllModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('pagibig.store-all-active') }}" method="POST">
                @csrf
...
<script>
    $(document).ready(function () {
        ...
        $('#export-excel').on('click', function() {
            ...
            var header = ['PAGIBIG NO.', 'Employee', 'Contribution Month', 'Employee Share', 'Employer Share', 'Total Contribution'];
            ...
            XLSX.utils.book_append_sheet(wb, ws, 'PAGIBIG Contributions');
            XLSX.writeFile(wb, 'pagibig_contributions.xlsx');
        });
    });
</script>
