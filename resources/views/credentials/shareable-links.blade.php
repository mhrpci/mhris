        ...
        <div class="col-lg-10 col-md-12">
            <div class="card shadow-sm border-0 rounded-lg">
                <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-primary">{{ __('Shareable Credential Links') }}</h5>
                    <a href="{{ route('credentials.share-form') }}" class="btn btn-primary btn-sm">
                        ...
                        <table class="table table-hover table-striped">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th>Description</th>
                                    <th width="10%" class="text-center">Credentials</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-1">
                                                <a href="{{ route('credentials.share-link', $link->token) }}" 
                                                   class="btn btn-sm btn-info text-white" title="View Details">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                @if($link->isActive())
                                                    <a href="{{ route('public.shared-credentials', $link->token) }}" 
                                                       class="btn btn-sm btn-success" title="Public Link" target="_blank">
                                                        <i class="fas fa-link"></i>
                                                    </a>
                                                @endif
                                                <form action="{{ route('credentials.delete-share', $link->id) }}" method="POST" 
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center py-4 text-muted">
                                            ...
                                            <a href="{{ route('credentials.share-form') }}" class="btn btn-primary btn-sm mt-2">
