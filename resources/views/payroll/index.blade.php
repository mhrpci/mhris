        ...
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title" id="dateSelectionModalLabel">
                    <i class="fas fa-calendar"></i> Select Payroll Period
                </h5>
                ...
                <div class="table-container">
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm table-striped" id="adjustmentTable">
                            ...
                            <tbody>
                                <tr class="bg-light department-header" data-department="SP">
                                ...
                                <!-- Employee rows -->
                                <tr class="employee-row" data-department="SP" data-search="BANAN BEVERLY B. SR. BOOKKEEPER">
                                    <td><span class="badge badge-secondary">2632</span></td>
                                    <td>BANAN, BEVERLY B.</td>
                                    <td>SR. BOOKKEEPER</td>
                                    <td>SP</td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="25000"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="1136.36"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="1163.70"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="2339.30"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="100.00"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="437.50"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="2348.80"></td>
                                </tr>
                                <tr class="employee-row" data-department="SP" data-search="MAGMANAN GRAZIELA MARIE JR. BOOKKEEPER">
                                    <td><span class="badge badge-secondary">3676</span></td>
                                    <td>MAGMANAN, GRAZIELA MARIE</td>
                                    <td>JR. BOOKKEEPER</td>
                                    <td>SP</td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="18000"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="818.18"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    ...
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="835.00"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="1683.40"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="100.00"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="315.00"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="1350.00"></td>
                                </tr>
                                <tr class="employee-row" data-department="SP" data-search="CABJUAS ANGEL CREDIT AND COLLECTION">
                                    <td><span class="badge badge-secondary">4670</span></td>
                                    <td>CABJUÁS, ANGEL</td>
                                    <td>CREDIT AND COLLECTION</td>
                                    <td>SP</td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="16000"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="727.27"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    ...
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="743.30"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="1496.70"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="100.00"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="280.00"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="876.70"></td>
                                </tr>

                                <tr class="bg-light department-header" data-department="HR">
                                    <td colspan="24" class="font-weight-bold">
                                        <i class="fas fa-chevron-down mr-2 toggle-department"></i>
                                        HUMAN RESOURCES
                                    </td>
                                ...
                                <!-- HR Employee rows -->
                                <tr class="employee-row" data-department="HR" data-search="DELA CRUZ JUAN HR MANAGER">
                                    <td><span class="badge badge-secondary">1201</span></td>
                                    <td>DELA CRUZ, JUAN</td>
                                    <td>HR MANAGER</td>
                                    <td>HR</td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="35000"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="1590.91"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    ...
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="1760.00"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="3500.00"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="100.00"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="612.50"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="0"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" placeholder="Enter value"></td>
                                    <td><input type="number" class="form-control form-control-sm" readonly value="4527.50"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
