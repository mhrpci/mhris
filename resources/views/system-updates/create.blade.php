...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-md-6">
            <h1 class="h3 mb-0 text-gray-800">Create System Update</h1>
            <p class="text-muted">Add a new system update or announcement</p>
        </div>
                    ...
                    <form action="{{ route('system-updates.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('published_at') is-invalid @enderror" id="published_at" name="published_at" value="{{ old('published_at', now()->format('Y-m-d')) }}" required>
                                        @error('published_at')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="d-flex justify-content-between form-actions">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save mr-1"></i> Create Update
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <h6><i class="fas fa-lightbulb text-warning mr-2"></i>Tips</h6>
                        <ul class="text-muted small pl-3">
                            <li>Use a clear, descriptive title</li>
                            <li>Provide detailed information in the description</li>
                            <li>Set the publish date to control when the update appears</li>
                            <li>Mark as active when ready to be displayed</li>
                        </ul>
                    </div>
