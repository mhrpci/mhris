                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools d-flex flex-wrap justify-content-end">
                            <div class="dropdown mr-2 mb-2">
                                <button class="btn btn-danger btn-sm dropdown-toggle rounded-pill" type="button" id="employeeStatusDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <tbody>
                                @foreach ($employees as $employee)
                                    <tr>
                                        ...
                                        <td>{{ $employee->terminated_date ? \Carbon\Carbon::parse($employee->terminated_date)->format('F j, Y') : 'N/A' }}</td>
    ...
    <script>
        $(document).ready(function () {
            let table = $('#terminated-employees-table').DataTable({
                columnDefs: [
                    {
                        targets: 4, // Targeting the "Termination Date" column (0-based index)
                        type: 'date'
                    }
                ],
                order: [
                    [4, 'desc'], // Sort by termination date in descending order (newest first)
