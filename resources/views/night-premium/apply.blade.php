        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Night Premium Application</h5>
                </div>
                <div class="card-body">
                    @if (session('error'))
                    ...
                    <form method="POST" action="{{ route('night-premium.apply') }}" id="nightPremiumForm">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('night-premium.history') }}" class="btn btn-light me-2">Cancel</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Form elements
        const form = document.getElementById('nightPremiumForm');
